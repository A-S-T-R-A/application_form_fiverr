                ...
                <header className="header">
                    ...
                    <div className="toggleContainer">
                        <div
                            ...
                            onClick={() =>
                                setFormData(prev => ({ ...prev, position: "phoneRepresentative" }))
                            }
                        >
                        ...
                        <div
                            className={`toggle ${position === "nonVoiceAssistant" ? "active" : ""}`}
                            onClick={() =>
                                setFormData(prev => ({ ...prev, position: "nonVoiceAssistant" }))
                            }
                        >
                            ...
                            <section className="formLeft">
                                ...
                                <div className="inputContainer age">
                                    ...
                                    <input
                                        ...
                                        id="age"
                                        value={age}
                                        onChange={e => inputChangeHandler(e.target.value, "age")}
                                        required
                                    />
                                </div>
                                ...
                                <div className="inputContainer mobile">
                                    ...
                                    <input
                                        ...
                                        id="phone"
                                        value={phone}
                                        onChange={e => inputChangeHandler(e.target.value, "phone")}
                                        required
                                    />
                                </div>
                                ...
                                <div className="inputContainer">
                                    ...
                                    <input
                                        ...
                                        id="fbLink"
                                        value={fbLink}
                                        onChange={e => inputChangeHandler(e.target.value, "fbLink")}
                                    />
                                </div>
                                ...
                                <div className="inputContainer">
                                    ...
                                    <input
                                        ...
                                        id="fbName"
                                        value={fbName}
                                        onChange={e => inputChangeHandler(e.target.value, "fbName")}
                                    />
                                </div>
                            </section>
